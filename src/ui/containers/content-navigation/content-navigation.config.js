  ...
  variants: [
    {
      ...
      context: {
        columnOne: [
          ...
          {
            label: 'Phasellus mattis diam convallis lectus ultricies',
            url: '#',
            description:
              'Doloremque laudantium, totam rem aperiam ipsa quae ab unde omnis.'
          },
          {
            label: 'Phasellus convallis lectus ultricies',
            url: '#',
        ...
        columnTwo: [
          ...
          },
          {
            label: 'Phasellus mattis diam convallis lectus ultricies',
            url: '#',
            description: 'Doloremque totam rem aperiam.'
          },
          {
            label: 'Phasellus convallis lectus ultricies',
            url: '#',
